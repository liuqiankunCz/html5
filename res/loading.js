...
(function() {
    ...
    var createDom = function(id, num) {
        ...
        image.id = "bg";
        image.src = "http://img.59600.com/i8/logoX.png";
    ...
    var startAnimation = function(list, callback) {
        ...
        document.body.style.background = "#ffc800";
