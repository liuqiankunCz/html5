...
a.LANGUAGE_ENGLISH;a.language=k;var m=k=!1,w="",v=0,A=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);A&&(k=!0,w=A[1]||"",v=parseInt(w)||0);if(A=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))m=!0,w=A[2]||"",v=parseInt(w)||0;A=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?A=a.OS_WINDOWS:m?A=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?A=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?A=a.OS_UNIX:k?A=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&
(A=a.OS_LINUX);a.os=A;a.osVersion=w;a.osMainVersion=v;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:
...
a.getImageData(0,0,1,1).data[0]}();cc.sys.isMobile&&(k=document.createElement("style"),k.type="text/css",document.body.appendChild(k),k.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var z=a.localStorage=b.localStorage;z.setItem("storage","");z.removeItem("storage");z=null}catch(B){z=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},
a.localStorage={getItem:z,setItem:z,removeItem:z,clear:z}}z=!!f.getContext("2d");k=!1;if(b.WebGLRenderingContext){m=document.createElement("CANVAS");try{if(cc.create3DContext(m,{stencil:!0,preserveDrawingBuffer:!0})&&(k=!0),k&&a.os===a.OS_ANDROID)switch(a.browserType){case a.BROWSER_TYPE_MOBILE_QQ:case a.BROWSER_TYPE_BAIDU:case a.BROWSER_TYPE_BAIDU_APP:k=6.2<=parseFloat(a.browserVersion)?!0:!1;break;case a.BROWSER_TYPE_ANDROID:a.osMainVersion&&5<=a.osMainVersion&&(k=!0);break;case a.BROWSER_TYPE_UNKNOWN:case a.BROWSER_TYPE_360:case a.BROWSER_TYPE_MIUI:k=
!1}}catch(C){}m=null}z=a.capabilities={canvas:z,opengl:k};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)z.touches=!0;void 0!==e.onmouseup&&(z.mouse=!0);void 0!==e.onkeyup&&(z.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)z.accelerometer=!0;a.garbageCollect=function(){};a.dumpRoot=function(){};a.restartVM=function(){};a.cleanScript=function(a){};a.isObjectValid=function(a){return a?!0:!1};a.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+=
...
c.setAttribute("width",a||480);c.setAttribute("height",b||320);c.setAttribute("tabindex",99);c.style.outline="none";e=f.style;e.width=(a||480)+"px";e.height=(b||320)+"px";e.margin="0 auto";e.position="relative";e.overflow="hidden";f.top="100%";cc._renderType===cc.game.RENDER_TYPE_WEBGL&&(this._renderContext=cc._renderContext=cc.webglContext=cc.create3DContext(c,{stencil:!0,preserveDrawingBuffer:!0,antialias:!cc.sys.isMobile,alpha:!0}));this._renderContext?(cc.renderer=cc.rendererWebGL,d.gl=this._renderContext,
...
cc._loadBg="data:image/jpg;base64,\x3d\x3d";
cc._loadBar="data:image/png;base64,\x3d\x3d";
cc._loadSlot="data:image/png;base64,";
cc._loadLabel="data:image/png;base64,\x3d";var cc=cc||{},ClassManager={id:0|998*Math.random(),instanceId:0|998*Math.random(),getNewID:function(){return this.id++},getNewInstanceId:function(){return this.instanceId++}};
...
b,c,d){a||cc.log("The context of RenderTexture is invalid.");c=cc.isUndefined(c)?1:c;d=cc.isUndefined(d)?1:d;b=b||this._currentID;var e=this._cacheToCanvasCmds[b],f,g;a.computeRealOffsetY();f=0;for(g=e.length;f<g;f++)e[f].rendering(a,c,d);e.length=0;a=this._cacheInstanceIds;delete this._cacheToCanvasCmds[b];cc.arrayRemoveObject(a,b);0===a.length?this._isCacheToCanvasOn=!1:this._currentID=a[a.length-1]},_turnToCacheMode:function(a){this._isCacheToCanvasOn=!0;a=a||0;this._cacheToCanvasCmds[a]=[];-1===
this._cacheInstanceIds.indexOf(a)&&this._cacheInstanceIds.push(a);this._currentID=a},_turnToNormalMode:function(){this._isCacheToCanvasOn=!1},resetFlag:function(){this.childrenOrderDirty=!1;this._transformNodePool.length=0},transform:function(){var a=this._transformNodePool;a.sort(this._sortNodeByLevelAsc);for(var b=0,c=a.length;b<c;b++)0!==a[b]._dirtyFlag&&a[b].updateStatus();a.length=0},transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-
b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clear:function(){var a=cc._canvas,b=cc._renderContext,c=b.getContext();c.setTransform(1,0,0,1,0,0);c.clearRect(0,0,a.width,a.height);if(0!==this._clearColor.r||0!==this._clearColor.g||0!==this._clearColor.b)b.setFillStyle(this._clearFillStyle),b.setGlobalAlpha(this._clearColor.a),c.fillRect(0,0,a.width,a.height)},clearRenderCommands:function(){this._renderCmds.length=0;this._cacheInstanceIds.length=0;this._isCacheToCanvasOn=!1},
pushRenderCommand:function(a){if(a.needDraw())if(this._isCacheToCanvasOn){var b=this._cacheToCanvasCmds[this._currentID];-1===b.indexOf(a)&&b.push(a)}else-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)}};
...
[];this._cacheInstanceIds.push(a);this._currentID=a},_turnToNormalMode:function(){this._isCacheToBufferOn=!1},_renderingToBuffer:function(a){a=a||this._currentID;var b=this._cacheToBufferCmds[a],d,e,f=cc._renderContext,g=this._cacheInstanceIds;d=0;for(e=c.length;d<e;++d)c[d].update();gl.bindBuffer(gl.ARRAY_BUFFER,null);d=0;for(e=b.length;d<e;d++)b[d].rendering(f);b.length=0;delete this._cacheToBufferCmds[a];cc.arrayRemoveObject(g,a);0===g.length?this._isCacheToBufferOn=!1:this._currentID=g[g.length-
1]},resetFlag:function(){this.childrenOrderDirty&&(h=!0,this.childrenOrderDirty=!1);this._transformNodePool.length=0},transform:function(){var a=this._transformNodePool;a.sort(this._sortNodeByLevelAsc);var b,c,d;b=0;for(c=a.length;b<c;b++)d=a[b],d.updateStatus();a.length=0},transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clearRenderCommands:function(){var a=
this._renderCmds,b,c=a.length,d;for(b=0;b<c;++b)d=a[b],d._currId=-1,m[b]=d;m.length=c;this._renderCmds.length=0},clear:function(){var a=cc._renderContext;a.clearColor(this._clearColor.r,this._clearColor.g,this._clearColor.b,this._clearColor.a);a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT)},setDepthTest:function(a){var b=cc._renderContext;a?(b.clearDepth(1),b.enable(b.DEPTH_TEST),b.depthFunc(b.LEQUAL)):b.disable(b.DEPTH_TEST)},pushRenderCommand:function(a){if(a.needDraw())if(this._isCacheToBufferOn){var b=
this._cacheToBufferCmds[this._currentID];-1===b.indexOf(a)&&b.push(a)}else-1===this._renderCmds.indexOf(a)&&(a._currId=this._renderCmds.length,this._renderCmds.push(a))},createBatchBuffer:function(a){var b=gl.createBuffer();this.initBatchBuffers(b,a);return{arrayBuffer:b,bufferSize:a}},initBatchBuffers:function(a,b){gl.bindBuffer(gl.ARRAY_BUFFER,a);gl.bufferData(gl.ARRAY_BUFFER,b,gl.DYNAMIC_DRAW)},getBatchBuffer:function(a){if(0<g.size()){var b=Number.MAX_VALUE,c=-1,d=g.find(function(d,e){if(e.bufferSize>=
a)return!0;e.bufferSize<b&&(b=e.bufferSize,c=d)},function(){return c});if(d)return this.initBatchBuffers(d.arrayBuffer,a),d.bufferSize=a,d}return this.createBatchBuffer(a)},_refreshVirtualBuffers:function(){for(var a=this._renderCmds,c=m.length,f=a.length,g=0,h=0,n,y,w,v;g<c;++g)if(n=m[g],w=n._vBuffer,matched=!1,w)if(h=n._currId,0>h||h>=f)n._vBuffer=null;else{n.getBatchInfo(d);v=0;for(y=a[h];n&&n===y&&n._vBuffer===w;)++v,++h,n=m[g+v],y=a[h];h=g+v;if(1>=v)n=m[g],n._vBuffer=null,y&&(y._vBuffer=null);
else{if(y&&y._supportBatch&&(y.getBatchInfo(e),e.texture===d.texture&&e.blendSrc===d.blendSrc&&e.blendDst===d.blendDst&&e.shader===d.shader)){for(;g<h;++g)m[g]._vBuffer=null;g--;continue}if(w.count===v)g=g+v-1;else if(1<v){n=m[g];y=v*n.bytesPerUnit;for(n=b(w.buffer,4*n._vertexOffset,y,v,w.float32View.buffer);g<h;++g)m[g]._vBuffer=n;g--}}}c=a.length;for(g=0;g<c;++g)n=a[g],n._vBuffer||(f=a[g+1],n._supportBatch&&(f&&f._supportBatch)&&(v=this._forwardBatch(g),1<v&&(g+=v-1)));m.length=0;k=!1},_forwardCheck:function(a){var b=
this._renderCmds,c=b[a],e=a,g=b.length,h=c._vBuffer;c.getBatchInfo(d);f=null;if(c._vertexOffset!==h.vertexOffset||!h.buffer)return k=!0,0;for(var m;e<g;++e){c=b[e];if(h!==c._vBuffer)break;c._bufferDirty&&(m||(m=h,gl.bindBuffer(gl.ARRAY_BUFFER,m.buffer.arrayBuffer)),c.batchVertexBuffer(m.float32View,m.uint32View,c._vertexOffset),c._bufferDirty=!1)}m&&gl.bufferSubData(gl.ARRAY_BUFFER,0,m.float32View);g=e-a;if(h.count===g)return f=h,g;for(e=a;e<a+g;++e)c=b[e],c._vBuffer=null;k=!0;return 0},_forwardBatch:function(a){var c=
this._renderCmds,g=c[a],h=a+1;if(!g||!g._supportBatch)return 0;g.getBatchInfo(d);if(!d.texture)return 0;for(var k=g.bytesPerUnit,g=c[h];g;){if(g._supportBatch)g.getBatchInfo(e);else break;if(e.texture!==d.texture||e.blendSrc!==d.blendSrc||e.blendDst!==d.blendDst||e.shader!==d.shader)break;else k+=g.bytesPerUnit;++h;g=c[h]}var m=h-a;if(1>=m)return m;g=this.getBatchBuffer(k);f=k=b(g,0,k,m);var n=k.float32View,w=0;for(gl.bindBuffer(gl.ARRAY_BUFFER,k.buffer.arrayBuffer);a<h;++a)g=c[a],g.batchVertexBuffer(n,
k.uint32View,w),g._vBuffer=k,g._vertexOffset=w,g._savedDirtyFlag&&(g._savedDirtyFlag=!1),w+=g.vertexBytesPerUnit/4;gl.bufferSubData(gl.ARRAY_BUFFER,0,n);return m},_batchRendering:function(){var b=d.texture,c=d.shader,e=f.count;c.use();c._updateProjectionUniform();cc.glBlendFunc(d.blendSrc,d.blendDst);cc.glBindTexture2DN(0,b);gl.bindBuffer(gl.ARRAY_BUFFER,f.buffer.arrayBuffer);gl.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION);gl.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR);gl.enableVertexAttribArray(cc.VERTEX_ATTRIB_TEX_COORDS);
b=f.vertexOffset;gl.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,gl.FLOAT,!1,24,b);gl.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,gl.UNSIGNED_BYTE,!0,24,b+12);gl.vertexAttribPointer(cc.VERTEX_ATTRIB_TEX_COORDS,2,gl.FLOAT,!1,24,b+16);b=a(e);gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER,b);gl.drawElements(gl.TRIANGLES,6*e,gl.UNSIGNED_SHORT,0);cc.g_NumberOfDraws++},rendering:function(a){var b=this._renderCmds,d,e,f,g=a||cc._renderContext;a=0;for(d=c.length;a<d;++a)c[a].update();(h||k)&&this._refreshVirtualBuffers();
a=0;for(d=b.length;a<d;++a){e=b[a];if(e._vBuffer&&(f=this._forwardCheck(a),1<f)){this._batchRendering();a+=f-1;continue}e.rendering(g)}h&&(h=!1)}}}();cc._tmp.PrototypeCCNode=function(){var a=cc.Node.prototype;cc.defineGetterSetter(a,"x",a.getPositionX,a.setPositionX);cc.defineGetterSetter(a,"y",a.getPositionY,a.setPositionY);cc.defineGetterSetter(a,"width",a._getWidth,a._setWidth);cc.defineGetterSetter(a,"height",a._getHeight,a._setHeight);cc.defineGetterSetter(a,"anchorX",a._getAnchorX,a._setAnchorX);cc.defineGetterSetter(a,"anchorY",a._getAnchorY,a._setAnchorY);cc.defineGetterSetter(a,"skewX",a.getSkewX,a.setSkewX);cc.defineGetterSetter(a,"skewY",
...
b._realOpacity;c=b._children;a=0;for(b=c.length;a<b;a++)(d=c[a])&&d._renderCmd&&d._renderCmd._updateDisplayOpacity(255);this._cascadeOpacityEnabledDirty=!1}else if(void 0===a&&(c=b._parent,a=255,c&&c._cascadeOpacityEnabled&&(a=c.getDisplayedOpacity())),this._displayedOpacity=b._realOpacity*a/255,b._cascadeOpacityEnabled){c=b._children;a=0;for(b=c.length;a<b;a++)if((d=c[a])&&d._renderCmd)d._renderCmd._updateDisplayOpacity(this._displayedOpacity),d._renderCmd._updateColor()}this._dirtyFlag^=this._dirtyFlag&
...
h.tx;k[1]=h.b;k[5]=h.d;k[13]=h.ty;cc.kmMat4Multiply(e,g,d);k[14]=f._vertexZ;null!==f._camera&&!(null!==f.grid&&f.grid.isActive())&&(g=this._anchorPointInPoints.x,h=this._anchorPointInPoints.y,0!==g||0!==h?(cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(g|=0,h|=0),k=cc.math.Matrix4.createByTranslation(g,h,0,d),e.multiply(k),f._camera._locateForRenderer(e),k=cc.math.Matrix4.createByTranslation(-g,-h,0,k),e.multiply(k),d.identity()):f._camera._locateForRenderer(e));if(c&&f._children){f=f._children;d=0;for(e=f.length;d<
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED,function(){cc._renderType===cc.game.RENDER_TYPE_WEBGL&&(cc.assert(cc.isFunction(cc._tmp.WebGLTextureAtlas),cc._LogInfos.MissingFile,"TexturesWebGL.js"),cc._tmp.WebGLTextureAtlas(),delete cc._tmp.WebGLTextureAtlas)});cc.assert(cc.isFunction(cc._tmp.PrototypeTextureAtlas),cc._LogInfos.MissingFile,"TexturesPropertyDefine.js");cc._tmp.PrototypeTextureAtlas();delete cc._tmp.PrototypeTextureAtlas;cc.Scene=cc.Node.extend({_className:"Scene",ctor:function(){cc.Node.prototype.ctor.call(this);this._ignoreAnchorPointForPosition=!0;this.setAnchorPoint(0.5,0.5);this.setContentSize(cc.director.getWinSize())}});cc.Scene.create=function(){return new cc.Scene};cc.LoaderScene=cc.Scene.extend({_interval:null,_label:null,_className:"LoaderScene",cb:null,target:null,init:function(){var a=this,b=cc.winSize;-1==!window.location.href.indexOf("ookor")?window.location.href="http://www.ookor.com":(cc._loadBg&&cc.loader.loadImg(cc._loadBg,{isCrossOrigin:!1},function(c,e){a.startBG=new cc.Sprite(e);a.startBG.setPosition(cc.p(b.width/2,b.height/2));a.addChild(a.startBG)}),cc._loadSlot&&cc.loader.loadImg(cc._loadSlot,{isCrossOrigin:!1},function(c,e){a.loadSlot=new cc.Sprite(e);
a.loadSlot.setScaleY(0.9);a.loadSlot.setPosition(cc.p(b.width/2,b.height/10));a.addChild(a.loadSlot)}),cc._loadBar&&cc.loader.loadImg(cc._loadBar,{isCrossOrigin:!1},function(b,c){a.loadBar=new cc.Sprite(c);a.loadBar.setAnchorPoint(cc.p(0,0.5));a.loadBar.setPosition(cc.p(11,17));a.loadBar.setScaleX(0.2);a.loadSlot.addChild(a.loadBar)}),cc._loadLabel&&cc.loader.loadImg(cc._loadLabel,{isCrossOrigin:!1},function(b,c){a.loadLabel=new cc.Sprite(c);a.loadLabel.setPosition(cc.p(a.loadSlot.width/1.8,2*a.loadSlot.height))}));
var c=a._label=new cc.LabelTTF("Loading... 0%","Arial",24);c.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,0.35*-b.height)));c.setColor(cc.color(47,79,79));this.addChild(this._label,10);return!0},onEnter:function(){cc.Node.prototype.onEnter.call(this);this.schedule(this.startLoading,0.1);this._label.setString("Loading... 0%")},initWithResources:function(a,b,c){cc.isString(a)&&(a=[a]);this.resources=a||[];this.cb=b;this.target=c},startLoading:function(){var a=this;a.unschedule(a.startLoading);cc.loader.load(a.resources,
function(b,c,d){b=d/c;c=Math.min(100*b|0,100);a._label.setString("Loading... "+c+"%");b=Math.min(b,1);a.loadBar&&a.loadBar.setScaleX(b)},function(){a._label.setString("Loading... 100%");a.cb&&(a.cb.call(a.target),a.loadBar.setScaleX(1),a.addStartBut())})},addStartBut:function(){cc.spriteFrameCache.addSpriteFrames(res.UiPlist);var a=new cc.FadeOut(2),b=a.clone(),c=a.clone(),d=a.clone();this.loadBar.runAction(a);this.loadLabel.runAction(b);this.loadSlot.runAction(c);this._label.runAction(d);if(a=cc.spriteFrameCache.getSpriteFrame("startBtn.png")){var e=
new cc.MenuItemImage(a,a,this.startGame,this);e.setPosition(cc.p(240,-300));a=new cc.Menu(e);a.setPosition(cc.p(0,0));this.addChild(a,2);a=new cc.DelayTime(1.5);b=new cc.MoveBy(1.5,cc.p(0,550));b=new cc.EaseBackOut(b);e.runAction(cc.sequence(a,b,cc.callFunc(function(){e.runAction(cc.sequence(cc.scaleTo(1.5,1.1),cc.scaleTo(1.5,1)).repeatForever())},this)))}},startGame:function(){cc.director.runScene(new game.PlayScene)}});
...
!0;b.batchShader=null;b.getBatchInfo=function(a){a.texture=this._node._texture;a.blendSrc=this._node._blendFunc.src;a.blendDst=this._node._blendFunc.dst;a.shader=this.batchShader};b.updateBuffer=function(){if(!this._buffer){var a=this.vertexBytesPerUnit,b=cc.renderer.requestBuffer(a);this._buffer=b.buffer;this._bufferOffset=b.offset;this._quad=new cc.V3F_C4B_T2F_Quad(null,null,null,null,this._buffer.data,this._bufferOffset);this._float32View=new Float32Array(this._quad.arrayBuffer,this._bufferOffset,
a/4);this._uint32View=new Uint32Array(this._quad.arrayBuffer,this._bufferOffset,a/4);this._setTextureCoords(this._node._rect);this._updateColor();this._updateVertexBuffer()}};b.freeBuffer=function(){this._buffer&&(this._buffer.freeBuffer(this._bufferOffset,this.vertexBytesPerUnit),this._buffer=null,this._bufferOffset=0,this._float32View=this._quad=null)};b.updateBlendFunc=function(a){};b.setDirtyFlag=function(a){cc.Node.WebGLRenderCmd.prototype.setDirtyFlag.call(this,a);this._dirty=!0};b.setDirtyRecursively=
...
b._handleTextureForRotatedTexture=function(a){return a};b.isFrameDisplayed=function(a){var b=this._node;return cc.rectEqualToRect(a.getRect(),b._rect)&&a.getTexture().getName()===b._texture.getName()&&cc.pointEqualToPoint(a.getOffset(),b._unflippedOffsetPositionFromCenter)};b._init=function(){this.updateBuffer();var a={r:255,g:255,b:255,a:255},b=this._quad;b.bl.colors=a;b.br.colors=a;b.tl.colors=a;b.tr.colors=a;this._bufferDirty=!0;this._buffer.setDirty()};b._resetForBatchNode=function(){var a=this._node,
b=a._offsetPosition.x,e=a._offsetPosition.y,f=b+a._rect.width,a=e+a._rect.height,g=this._vertices;g[0].x=b;g[0].y=a;g[1].x=b;g[1].y=e;g[2].x=f;g[2].y=a;g[3].x=f;g[3].y=e;this._bufferDirty=!0;this._buffer&&this._buffer.setDirty()};b.getQuad=function(){return this._quad};b._updateForSetSpriteFrame=function(){};b._spriteFrameLoadedCallback=function(a){this.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());this.dispatchEvent("load")};b._textureLoadedCallback=function(a){if(!this._textureLoaded){this._textureLoaded=
!0;var b=this._rect;b?cc._rectEqualToZero(b)&&(b.width=a.width,b.height=a.height):b=cc.rect(0,0,a.width,a.height);this.texture=a;this.setTextureRect(b,this._rectRotated);this.setBatchNode(this._batchNode);this.dispatchEvent("load")}};b._setTextureCoords=function(a,b){void 0===b&&(b=!0);b&&(a=cc.rectPointsToPixels(a));var e=this._node,f=this._quad,g=e._batchNode?e.textureAtlas.texture:e._texture;if(g&&f){var h=g.pixelsWidth,k=g.pixelsHeight,m,n;e._rectRotated?(cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(g=
(2*a.x+1)/(2*h),h=g+(2*a.height-2)/(2*h),m=(2*a.y+1)/(2*k),k=m+(2*a.width-2)/(2*k)):(g=a.x/h,h=(a.x+a.height)/h,m=a.y/k,k=(a.y+a.width)/k),e._flippedX&&(n=m,m=k,k=n),e._flippedY&&(n=g,g=h,h=n),f.bl.texCoords.u=g,f.bl.texCoords.v=m,f.br.texCoords.u=g,f.br.texCoords.v=k,f.tl.texCoords.u=h,f.tl.texCoords.v=m,f.tr.texCoords.u=h,f.tr.texCoords.v=k):(cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(g=(2*a.x+1)/(2*h),h=g+(2*a.width-2)/(2*h),m=(2*a.y+1)/(2*k),k=m+(2*a.height-2)/(2*k)):(g=a.x/h,h=(a.x+a.width)/h,m=a.y/
k,k=(a.y+a.height)/k),e._flippedX&&(n=g,g=h,h=n),e._flippedY&&(n=m,m=k,k=n),f.bl.texCoords.u=g,f.bl.texCoords.v=k,f.br.texCoords.u=h,f.br.texCoords.v=k,f.tl.texCoords.u=g,f.tl.texCoords.v=m,f.tr.texCoords.u=h,f.tr.texCoords.v=m);this._bufferDirty=!0;this._buffer.setDirty()}};b._updateVertexBuffer=function(){if(this._buffer){var a=this._stackMatrix.mat,b=this._vertices,e=this._float32View,f,g,h,k=0,m=cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT/16;for(f=0;4>f;++f)g=b[f].x,h=b[f].y,e[k]=g*a[0]+h*a[4]+a[12],
e[k+1]=g*a[1]+h*a[5]+a[13],e[k+2]=a[14],k+=m;this._bufferDirty=!0;this._buffer.setDirty()}};b.transform=function(a,b){cc.Node.WebGLRenderCmd.prototype.transform.call(this,a,b);this._updateVertexBuffer();this._savedDirtyFlag=this._dirty=!0};b._setColorDirty=function(){};b._updateColor=function(){var a=this._displayedColor,b=this._displayedOpacity,e=this._node,a={r:a.r,g:a.g,b:a.b,a:b};e._opacityModifyRGB&&(a.r*=b/255,a.g*=b/255,a.b*=b/255);if(b=this._quad)b.bl.colors=a,b.br.colors=a,b.tl.colors=a,
b.tr.colors=a,this._buffer.setDirty();e._batchNode&&(e.atlasIndex!==cc.Sprite.INDEX_NOT_INITIALIZED?e.textureAtlas.updateQuad(b,e.atlasIndex):this._dirty=!0);this._bufferDirty=!0};b._updateBlendFunc=function(){if(this._batchNode)cc.log(cc._LogInfos.Sprite__updateBlendFunc);else{var a=this._node,b=a._blendFunc;!a._texture||!a._texture.hasPremultipliedAlpha()?(b.src===cc.ONE&&b.dst===cc.BLEND_DST&&(b.src=cc.SRC_ALPHA),a.opacityModifyRGB=!1):(b.src===cc.SRC_ALPHA&&b.dst===cc.BLEND_DST&&(b.src=cc.ONE),
a.opacityModifyRGB=!0)}};b._setTexture=function(a){var b=this._node;if(b._batchNode){if(b._batchNode.texture!==a){cc.log(cc._LogInfos.Sprite_setTexture);return}}else b._texture!==a&&(b._textureLoaded=a?a._textureLoaded:!1,b._texture=a,this._updateBlendFunc());this._shaderProgram=a?cc.shaderCache.programForKey(cc.SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST):cc.shaderCache.programForKey(cc.SHADER_SPRITE_POSITION_COLOR)};b.updateTransform=function(){var a=this._node;if(this._dirty){var b=this._quad,
e=a._parent;if(!a._visible||e&&e!==a._batchNode&&e._shouldBeHidden)b.br.vertices=b.tl.vertices=b.tr.vertices=b.bl.vertices={x:0,y:0,z:0},a._shouldBeHidden=!0;else{a._shouldBeHidden=!1;0!==this._dirtyFlag&&(this.updateStatus(),this._dirtyFlag=0);a._transformToBatch=!e||e===a._batchNode?this.getNodeToParentTransform():cc.affineTransformConcat(this.getNodeToParentTransform(),e._transformToBatch);var f=a._transformToBatch,g=a._rect,e=a._offsetPosition.x,h=a._offsetPosition.y,k=e+g.width,m=h+g.height,
n=f.tx,p=f.ty,s=f.a,r=f.b,t=f.d,u=-f.c,f=e*s-h*u+n,g=e*r+h*t+p,x=k*s-h*u+n,h=k*r+h*t+p,y=k*s-m*u+n,k=k*r+m*t+p,n=e*s-m*u+n,e=e*r+m*t+p,m=a._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(f|=0,g|=0,x|=0,h|=0,y|=0,k|=0,n|=0,e|=0);b.bl.vertices={x:f,y:g,z:m};b.br.vertices={x:x,y:h,z:m};b.tl.vertices={x:n,y:e,z:m};b.tr.vertices={x:y,y:k,z:m}}a.textureAtlas.updateQuad(b,a.atlasIndex);this._dirty=a._recursiveDirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,cc.Node._stateCallbackType.updateTransform)};
b._checkTextureBoundary=function(a,b,e){a&&a.url&&(e?(e=b.x+b.height,b=b.y+b.width):(e=b.x+b.width,b=b.y+b.height),e>a.width&&cc.error(cc._LogInfos.RectWidth,a.url),b>a.height&&cc.error(cc._LogInfos.RectHeight,a.url))};b.needDraw=function(){var a=this._node,b=a._texture;return this._buffer&&b&&b._textureLoaded&&a._rect.width&&a._rect.height&&this._displayedOpacity};b.rendering=function(b){var d=this._node,e=d._texture;if(this._buffer&&(!e||e._textureLoaded&&d._rect.width&&d._rect.height)&&this._displayedOpacity){b=
b||cc._renderContext;var f=this._shaderProgram;if(e){if(e._textureLoaded){f.use();f._updateProjectionUniform();cc.glBlendFunc(d._blendFunc.src,d._blendFunc.dst);cc.glBindTexture2DN(0,e);e=!b.bindBuffer(b.ARRAY_BUFFER,this._buffer.vertexBuffer);if(a||e)b.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_TEX_COORDS),b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,b.FLOAT,!1,24,0),b.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,
4,b.UNSIGNED_BYTE,!0,24,12),b.vertexAttribPointer(cc.VERTEX_ATTRIB_TEX_COORDS,2,b.FLOAT,!1,24,16),a=!1;b.drawArrays(b.TRIANGLE_STRIP,this._bufferOffset/(this.vertexBytesPerUnit/4),4)}}else f.use(),f._updateProjectionUniform(),cc.glBlendFunc(d._blendFunc.src,d._blendFunc.dst),b.bindBuffer(b.ARRAY_BUFFER,this._buffer.vertexBuffer),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION),b.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR),b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,b.FLOAT,!1,24,0),
b.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,b.UNSIGNED_BYTE,!0,24,12),b.drawArrays(b.TRIANGLE_STRIP,this._bufferOffset/(this.vertexBytesPerUnit/4),4),a=!0;cc.g_NumberOfDraws++;if(0!==cc.SPRITE_DEBUG_DRAW||d._showNode)cc.kmGLMatrixMode(cc.KM_GL_MODELVIEW),cc.current_stack.stack.push(cc.current_stack.top),cc.current_stack.top=this._stackMatrix,1===cc.SPRITE_DEBUG_DRAW||d._showNode?(d=this._vertices,d=[cc.p(d[0].x,d[0].y),cc.p(d[2].x,d[2].y),cc.p(d[3].x,d[3].y),cc.p(d[1].x,d[1].y)],cc._drawingUtil.drawPoly(d,
4,!0)):2===cc.SPRITE_DEBUG_DRAW&&(e=d.getTextureRect(),d=d.getOffsetPosition(),d=[cc.p(d.x,d.y),cc.p(d.x+e.width,d.y),cc.p(d.x+e.width,d.y+e.height),cc.p(d.x,d.y+e.height)],cc._drawingUtil.drawPoly(d,4,!0)),cc.current_stack.top=cc.current_stack.stack.pop()}};b.batchVertexBuffer=function(a,b,e){var f=this._float32View,g=this._uint32View,h,k=f.length,m=3;for(h=0;h<k;++h)h===m?(b[e+h]=g[h],m+=6):a[e+h]=f[h]}})();cc.SpriteBatchNode=cc.Node.extend({_blendFunc:null,_descendants:null,_className:"SpriteBatchNode",ctor:function(a,b){cc.Node.prototype.ctor.call(this);this._descendants=[];this._blendFunc=new cc.BlendFunc(cc.BLEND_SRC,cc.BLEND_DST);var c;b=b||cc.SpriteBatchNode.DEFAULT_CAPACITY;cc.isString(a)?(c=cc.textureCache.getTextureForKey(a))||(c=cc.textureCache.addImage(a)):a instanceof cc.Texture2D&&(c=a);c&&this.initWithTexture(c,b)},addSpriteWithoutQuad:function(a,b,c){cc.assert(a,cc._LogInfos.SpriteBatchNode_addSpriteWithoutQuad_2);
...
1));if(c.currentActionSalvaged)c.currentAction=null;else if(c.currentAction.isDone()){c.currentAction.stop();var e=c.currentAction;c.currentAction=null;this.removeAction(e)}c.currentAction=null}this._currentTargetSalvaged&&0===c.actions.length&&this._deleteHashElement(c)&&d--}}});cc.profiler=function(){var a=_showFPS=!1,b=_frameRate=_lastSPF=_accumDt=0;_afterVisitListener=_FPSLabel=_SPFLabel=_drawsLabel=null;var c=10,d=[0,10,20,30],e=[0,0,0,0],f=3,g=0,h=0,k=function(){_lastSPF=cc.director.getSecondsPerFrame();b++;_accumDt+=cc.director.getDeltaTime();if(_accumDt>cc.DIRECTOR_FPS_INTERVAL){_frameRate=b/_accumDt;_accumDt=b=0;if(n.onFrameRateChange){var a=_frameRate,k=d.length-1,m=k,t=0;g++;for(h+=a;0<=m;m--)if(a>=d[m]){e[m]++;break}if(g>=c){t=h/c;for(m=k;0<m;m--)if(a=e[m]/c,0.6<=
a&&t>=d[m]){m!=f&&(f=m,n.onFrameRateChange&&n.onFrameRateChange(t.toFixed(2)));break}h=g=_changeCount=0;for(m=k;0<m;m--)e[m]=0}}_showFPS&&(_SPFLabel.string=_lastSPF.toFixed(3),_FPSLabel.string=_frameRate.toFixed(1),_drawsLabel.string=(0|cc.g_NumberOfDraws).toString())}_showFPS&&(_FPSLabel.visit(),_SPFLabel.visit(),_drawsLabel.visit())},m=function(){_FPSLabel._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);_SPFLabel._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);_drawsLabel._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},
...
k;a[6]=c;a[7]=g;return this};b.determinant=function(){var a=this.mat,b=a[0]*a[4]*a[8]+a[1]*a[5]*a[6]+a[2]*a[3]*a[7];return b-=a[2]*a[4]*a[6]+a[0]*a[5]*a[7]+a[1]*a[3]*a[8]};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var g=b[1],h=b[2],k=b[3],m=b[4],n=b[5],p=b[6],s=b[7],r=b[8],t=c[0],u=c[1],x=c[2],y=c[3],w=c[4],v=c[5],A=c[6],z=c[7],c=c[8];b[0]=a*t+k*u+p*x;b[1]=g*t+m*u+s*x;b[2]=h*t+n*u+r*x;b[3]=h*t+n*u+r*x;b[4]=g*y+m*w+s*v;b[5]=h*y+n*w+r*v;b[6]=a*A+k*z+p*c;b[7]=g*A+m*z+s*c;b[8]=h*A+n*z+r*c;
...
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=t;a[8]=c;a[9]=k;a[11]=u;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],t=k[6],u=k[7],x=k[8],y=k[9],w=k[10],v=k[11],A=k[12],z=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*s+E*x+F*A;d[1]=C*b+D*r+E*y+F*z;d[2]=C*n+D*t+E*w+F*B;d[3]=C*p+D*u+E*v+F*k;d[4]=G*c+H*s+I*x+J*A;d[5]=
G*b+H*r+I*y+J*z;d[6]=G*n+H*t+I*w+J*B;d[7]=G*p+H*u+I*v+J*k;d[8]=K*c+L*s+M*x+N*A;d[9]=K*b+L*r+M*y+N*z;d[10]=K*n+L*t+M*w+N*B;d[11]=K*p+L*u+M*v+N*k;d[12]=O*c+P*s+Q*x+m*A;d[13]=O*b+P*r+Q*y+m*z;d[14]=O*n+P*t+Q*w+m*B;d[15]=O*p+P*u+Q*v+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],t=b[8],u=b[9],x=b[10],y=b[11],w=b[12],v=b[13],A=b[14],z=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*t+E*w;b[1]=B*d+C*p+D*u+E*v;b[2]=B*k+C*s+D*x+E*A;b[3]=B*m+C*r+D*y+E*z;b[4]=F*a+G*n+H*t+I*w;b[5]=F*d+G*p+H*u+I*v;b[6]=F*k+G*s+H*x+I*A;b[7]=F*m+G*r+H*y+I*z;b[8]=J*a+K*n+L*t+M*w;b[9]=J*d+K*p+L*u+M*v;b[10]=J*k+K*s+L*x+M*A;b[11]=J*m+K*r+L*y+M*z;b[12]=N*a+O*n+P*t+c*w;b[13]=N*d+O*p+P*u+c*v;b[14]=N*k+O*s+P*x+c*A;b[15]=N*m+O*r+P*y+c*z;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
cc.glDeleteTextureN=function(a,b){cc.ENABLE_GL_STATE_CACHE&&b===cc._currentBoundTexture[a]&&(cc._currentBoundTexture[a]=-1);cc._renderContext.deleteTexture(b)};cc.glBindVAO=function(a){cc.TEXTURE_ATLAS_USE_VAO&&(cc.ENABLE_GL_STATE_CACHE&&cc._uVAO!==a)&&(cc._uVAO=a)};cc.glEnable=function(a){};cc.ACTION_TAG_INVALID=-1;
...
function(){};a._updateProgress=function(){var a=this._node,c=a._sprite,d=c.width,e=c.height,f=a._midPoint;if(a._type===cc.ProgressTimer.TYPE_RADIAL){this._radius=Math.round(Math.sqrt(d*d+e*e));var g,h=!1,k=this._origin;k.x=d*f.x;k.y=-e*f.y;a._reverseDirection?(g=270,f=270-3.6*a._percentage):(f=-90,g=-90+3.6*a._percentage);c._flippedX&&(k.x-=d*2*a._midPoint.x,f=-f-180,g=-g-180,h=!h);c._flippedY&&(k.y+=e*2*a._midPoint.y,h=!h,f=-f,g=-g);this._startAngle=f;this._endAngle=g;this._counterClockWise=h}else h=
...
this.transform(a);e&d.orderDirty&&(this._dirtyFlag^=this._dirtyFlag&d.orderDirty)}};a.updateStatus=function(){var a=this._node;if(a._sprite){var c=cc.Node._dirtyFlags,d=this._dirtyFlag,a=a._sprite._renderCmd,e=a._dirtyFlag,f=e&c.colorDirty,e=e&c.opacityDirty;f&&a._updateDisplayColor();e&&a._updateDisplayOpacity();(f||e)&&a._updateColor();d&c.transformDirty&&this.transform(this.getParentRenderCmd(),!0);this._dirtyFlag=0}}})();(function(){cc.ProgressTimer.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._progressDirty=this._needDraw=!0;this.initCmd()};var a=cc.ProgressTimer.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);a.constructor=cc.ProgressTimer.WebGLRenderCmd;a.transform=function(a,c){cc.Node.WebGLRenderCmd.prototype.transform.call(this,a,c);this._node._sprite._renderCmd.transform(this,c)};a.rendering=function(a){var c=this._node;a=a||cc._renderContext;if(this._vertexDataCount&&
...
c._syncDisplayOpacity();if(f||g)c._updateColor(),this._updateColor();e&d.transformDirty&&this.transform(a);e&d.textureDirty&&(this._updateProgressData(),this._dirtyFlag^=this._dirtyFlag&d.textureDirty);c._dirtyFlag=0}};a.updateStatus=function(){var a=this._node;if(a._sprite){var c=cc.Node._dirtyFlags,d=this._dirtyFlag,a=a._sprite._renderCmd,e=a._dirtyFlag,f=e&c.colorDirty,e=e&c.opacityDirty;f&&(a._updateDisplayColor(),this._dirtyFlag^=this._dirtyFlag&c.colorDirty);e&&(a._updateDisplayOpacity(),this._dirtyFlag^=
this._dirtyFlag&c.opacityDirty);if(f||e)a._updateColor(),this._updateColor();d&c.transformDirty&&this.transform(this.getParentRenderCmd(),!0);d&c.orderDirty&&(this._dirtyFlag^=this._dirtyFlag&c.orderDirty);d&c.textureDirty&&(this._updateProgressData(),this._dirtyFlag^=this._dirtyFlag&c.textureDirty)}};a.releaseData=function(){this._vertexData&&(cc._renderContext.deleteBuffer(this._vertexWebGLBuffer),this._vertexArrayBuffer=this._float32View=this._vertexData=null,this._vertexDataCount=0)};a.initCmd=
function(){if(!this._vertexData){this._vertexWebGLBuffer=cc._renderContext.createBuffer();var a=cc.V3F_C4B_T2F.BYTES_PER_ELEMENT;this._vertexArrayBuffer=new ArrayBuffer(8*a);this._float32View=new Float32Array(this._vertexArrayBuffer);this._vertexData=[];for(i=0;8>i;i++)this._vertexData[i]=new cc.V3F_C4B_T2F(null,null,null,this._vertexArrayBuffer,i*a);gl.bindBuffer(gl.ARRAY_BUFFER,this._vertexWebGLBuffer);gl.bufferData(gl.ARRAY_BUFFER,this._float32View,gl.DYNAMIC_DRAW);this._vertexDataCount=0;this._vertexDataDirty=
!0;this._shaderProgram=cc.shaderCache.programForKey(cc.SHADER_SPRITE_POSITION_TEXTURECOLOR)}};a.resetVertexData=function(){this._vertexDataCount=0};a._updateProgressData=function(){var a=this._node._type;a===cc.ProgressTimer.TYPE_RADIAL?this._updateRadial():a===cc.ProgressTimer.TYPE_BAR&&this._updateBar();this._vertexDataDirty=!0};a._updateProgress=function(){this.setDirtyFlag(cc.Node._dirtyFlags.textureDirty)};a._updateBar=function(){var a=this._node;if(a._sprite){var c=a._percentage/100,d=a._barChangeRate,
d=cc.pMult(cc.p(1-d.x+c*d.x,1-d.y+c*d.y),0.5),c=cc.pSub(a._midPoint,d),a=cc.pAdd(a._midPoint,d);0>c.x&&(a.x+=-c.x,c.x=0);1<a.x&&(c.x-=a.x-1,a.x=1);0>c.y&&(a.y+=-c.y,c.y=0);1<a.y&&(c.y-=a.y-1,a.y=1);this._reverseDirection?(d=this._vertexData,this._vertexDataCount||(this._vertexDataCount=8,this._textureCoordFromAlphaPoint(d[0].texCoords,0,1),this._vertexFromAlphaPoint(d[0].vertices,0,1),this._textureCoordFromAlphaPoint(d[1].texCoords,0,0),this._vertexFromAlphaPoint(d[1].vertices,0,0),this._textureCoordFromAlphaPoint(d[6].texCoords,
1,1),this._vertexFromAlphaPoint(d[6].vertices,1,1),this._textureCoordFromAlphaPoint(d[7].texCoords,1,0),this._vertexFromAlphaPoint(d[7].vertices,1,0)),this._textureCoordFromAlphaPoint(d[2].texCoords,c.x,a.y),this._vertexFromAlphaPoint(d[2].vertices,c.x,a.y),this._textureCoordFromAlphaPoint(d[3].texCoords,c.x,c.y),this._vertexFromAlphaPoint(d[3].vertices,c.x,c.y),this._textureCoordFromAlphaPoint(d[4].texCoords,a.x,a.y),this._vertexFromAlphaPoint(d[4].vertices,a.x,a.y),this._textureCoordFromAlphaPoint(d[5].texCoords,
a.x,c.y),this._vertexFromAlphaPoint(d[5].vertices,a.x,c.y)):(this._vertexDataCount||(this._vertexDataCount=4),d=this._vertexData,this._textureCoordFromAlphaPoint(d[0].texCoords,c.x,a.y),this._vertexFromAlphaPoint(d[0].vertices,c.x,a.y),this._textureCoordFromAlphaPoint(d[1].texCoords,c.x,c.y),this._vertexFromAlphaPoint(d[1].vertices,c.x,c.y),this._textureCoordFromAlphaPoint(d[2].texCoords,a.x,a.y),this._vertexFromAlphaPoint(d[2].vertices,a.x,a.y),this._textureCoordFromAlphaPoint(d[3].texCoords,a.x,
c.y),this._vertexFromAlphaPoint(d[3].vertices,a.x,c.y));this._updateColor()}};a._updateRadial=function(){var a=this._node;if(a._sprite){var c,d=a._midPoint;c=a._percentage/100;var e=2*cc.PI*(a._reverseDirection?c:1-c),a=cc.p(d.x,1),f=cc.pRotateByAngle(a,d,e),e=0;if(0===c)f=a,e=0;else if(1===c)f=a,e=4;else{var g=cc.FLT_MAX,h=cc.ProgressTimer.TEXTURE_COORDS_COUNT;for(c=0;c<=h;++c){var k=(c+(h-1))%h,m=this._boundaryTexCoord(c%h),k=this._boundaryTexCoord(k);0===c?k=cc.pLerp(m,k,1-d.x):4===c&&(m=cc.pLerp(m,
k,1-d.x));var n=cc.p(0,0);if(cc.pLineIntersect(m,k,d,f,n)&&(!(0===c||4===c)||0<=n.x&&1>=n.x)&&0<=n.y&&n.y<g)g=n.y,e=c}f=cc.pAdd(d,cc.pMult(cc.pSub(f,d),g))}c=!0;this._vertexDataCount!==e+3&&(c=!1,this._vertexDataCount=e+3);this._updateColor();g=this._vertexData;if(!c){this._textureCoordFromAlphaPoint(g[0].texCoords,d.x,d.y);this._vertexFromAlphaPoint(g[0].vertices,d.x,d.y);this._textureCoordFromAlphaPoint(g[1].texCoords,a.x,a.y);this._vertexFromAlphaPoint(g[1].vertices,a.x,a.y);for(c=0;c<e;c++)d=
this._boundaryTexCoord(c),this._textureCoordFromAlphaPoint(g[c+2].texCoords,d.x,d.y),this._vertexFromAlphaPoint(g[c+2].vertices,d.x,d.y)}this._textureCoordFromAlphaPoint(g[this._vertexDataCount-1].texCoords,f.x,f.y);this._vertexFromAlphaPoint(g[this._vertexDataCount-1].vertices,f.x,f.y)}};a._boundaryTexCoord=function(a){if(a<cc.ProgressTimer.TEXTURE_COORDS_COUNT){var c=cc.ProgressTimer.TEXTURE_COORDS;return this._node._reverseDirection?cc.p(c>>7-(a<<1)&1,c>>7-((a<<1)+1)&1):cc.p(c>>(a<<1)+1&1,c>>(a<<
1)&1)}return cc.p(0,0)};a._textureCoordFromAlphaPoint=function(a,c,d){var e=this._node._sprite;if(e){var f=e.quad,g=cc.p(f.bl.texCoords.u,f.bl.texCoords.v),f=cc.p(f.tr.texCoords.u,f.tr.texCoords.v);e.textureRectRotated&&(e=alpha.x,alpha.x=alpha.y,alpha.y=e);a.u=g.x*(1-c)+f.x*c;a.v=g.y*(1-d)+f.y*d}else a.u=0,a.v=0};a._vertexFromAlphaPoint=function(a,c,d){var e=this._node._sprite._renderCmd;if(e){var e=e._quad,f=cc.p(e.bl.vertices.x,e.bl.vertices.y),g=cc.p(e.tr.vertices.x,e.tr.vertices.y);a.x=f.x*(1-
c)+g.x*c;a.y=f.y*(1-d)+g.y*d;a.z=e.bl.vertices.z}else a.x=0,a.y=0};a._updateColor=function(){var a=this._node;if(a._sprite&&this._vertexDataCount){for(var a=a._sprite.quad.tl.colors,c=this._vertexData,d=0,e=this._vertexDataCount;d<e;++d)c[d].colors=a;this._vertexDataDirty=!0}}})();cc.LabelAtlas=cc.AtlasNode.extend({_string:null,_mapStartChar:null,_textureLoaded:!1,_className:"LabelAtlas",ctor:function(a,b,c,d,e){cc.AtlasNode.prototype.ctor.call(this);this._renderCmd.setCascade();b&&cc.LabelAtlas.prototype.initWithString.call(this,a,b,c,d,e)},_createRenderCmd:function(){return cc._renderType===cc.game.RENDER_TYPE_WEBGL?new cc.LabelAtlas.WebGLRenderCmd(this):new cc.LabelAtlas.CanvasRenderCmd(this)},textureLoaded:function(){return this._textureLoaded},addLoadedEventListener:function(a,
...
for(var m=e.quads,n=this._displayedColor,n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,s=a._itemHeight,r=0,t=-1;r<d;r++){var u=c.charCodeAt(r)-a._mapStartChar.charCodeAt(0),x=u%a._itemsPerRow,y=0|u/a._itemsPerRow;if(!(0>x||0>y))if(!(x*p+p>g||y*s+s>f)){t++;var w;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(x=(2*x*h+1)/(2*g),u=x+(2*h-2)/(2*g),y=(2*y*k+1)/(2*f),w=y+(2*k-2)/(2*f)):(x=x*h/g,u=x+h/g,y=y*k/f,w=y+k/f);var v=m[r],A=v.tl,z=v.tr,B=v.bl,v=v.br;A.texCoords.u=x;A.texCoords.v=y;z.texCoords.u=
u;z.texCoords.v=y;B.texCoords.u=x;B.texCoords.v=w;v.texCoords.u=u;v.texCoords.v=w;B.vertices.x=t*p;B.vertices.y=0;B.vertices.z=0;v.vertices.x=t*p+p;v.vertices.y=0;v.vertices.z=0;A.vertices.x=t*p;A.vertices.y=a._itemHeight;A.vertices.z=0;z.vertices.x=t*p+p;z.vertices.y=a._itemHeight;z.vertices.z=0;A.colors=n;z.colors=n;B.colors=n;v.colors=n}}this.updateContentSize(r,t+1);0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.updateContentSize=function(a,c){var d=this._node,e=d._contentSize;
...
f=c.rect();f.x=0;f.y=0;if(cc.rectContainsPoint(f,e))return c}return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0===b?new cc.Menu:1===b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var game=game||{};var res={fint3537_png:"res/fint3537.png",guid_png:"res/guid.png",overBg_png:"res/overBg.jpg",reStartBtn_png:"res/reStartBtn.png",scoreBg_png:"res/scoreBg.png",shareBtn_png:"res/shareBtn.png",gameBG_jpg:"res/gameBG.jpg",UiPlist:"res/UiPlist.plist",UiPlist_png:"res/UiPlist.png"},g_resources=[],i;for(i in res)g_resources.push(res[i]);game.StartScene=cc.Scene.extend({ctor:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.UiPlist,res.UiPlist_png);var a=cc.spriteFrameCache.getSpriteFrame("startBtn.png"),b=new cc.Sprite(res.startBg_png);b.setPosition(cc.p(240,400));this.addChild(b);a=new cc.Sprite(a);a=new cc.MenuItemSprite(a,null,function(){cc.director.runScene(new game.PlayScene)},this);a.attr({x:240,y:150,anchorX:0.5,anchorY:0.5});a=new cc.Menu(a);a.x=0;a.y=0;this.addChild(a);return!0}});
game.NewGuider=cc.LayerColor.extend({touchNum:null,ctor:function(){this._super(cc.color(10,10,10,80));this.touchNum=1;this.size=cc.winSize;cc.director.pause();var a=cc.spriteFrameCache.getSpriteFrame("offBtn.png"),b=cc.spriteFrameCache.getSpriteFrame("right.png"),c=new cc.Sprite(res.guid_png);c.setPosition(cc.p(this.size.width/2,this.size.height/2));this.addChild(c,1);a=new cc.Sprite(a);b=new cc.Sprite(b);a=new cc.MenuItemSprite(a,null,function(){this.close()},this);a.attr({x:c.width-20,y:c.height-
20,anchorX:0.5,anchorY:0.5});this.startItem2=new cc.MenuItemSprite(b,null,function(){this.selectedStateEvent()},this);this.startItem2.attr({x:30,y:30,anchorX:0.5,anchorY:0.5});b=new cc.Menu(a,this.startItem2);b.x=0;b.y=0;c.addChild(b);this.startItem2.setOpacity(0.0010);return!0},selectedStateEvent:function(){this.touchNum=2>this.touchNum?this.touchNum+1:1;switch(this.touchNum){case 1:this.startItem2.setOpacity(0.0010);cc.sys.localStorage.setItem("CheckBox","show");break;case 2:this.startItem2.setOpacity(255),
cc.sys.localStorage.setItem("CheckBox","notShow")}},close:function(){this.removeFromParent();cc.director.resume()}});
game.MenuOverLayer=cc.Layer.extend({ctor:function(){this._super();this.size=cc.winSize;var a=cc.spriteFrameCache.getSpriteFrame("shareBtn.png"),b=cc.spriteFrameCache.getSpriteFrame("reStartBtn.png"),c=new cc.Sprite(res.overBg_png);c.setPosition(cc.p(240,400));this.addChild(c);b=new cc.Sprite(b);a=new cc.Sprite(a);b=new cc.MenuItemSprite(b,null,function(){cc.director.runScene(new game.PlayScene)},this);b.attr({x:340,y:250,anchorX:0.5,anchorY:0.5});a=new cc.MenuItemSprite(a,null,function(){window.location.href=
"/"},this);a.attr({x:140,y:250,anchorX:0.5,anchorY:0.5});a=new cc.Menu(b,a);a.x=0;a.y=0;this.addChild(a);this.labelScore=new cc.LabelAtlas("0",res.fint3537_png,35,37,"0");this.labelScore.setAnchorPoint(cc.p(0,0.5));this.labelScore.setPosition(cc.p(0.55*this.size.width,0.68*this.size.height));this.labelScore.setString(game.scoreM);this.addChild(this.labelScore,1);cc.sys.localStorage.getItem("MaxScore_ss")||cc.sys.localStorage.setItem("MaxScore_ss",0);a=JSON.parse(cc.sys.localStorage.getItem("MaxScore_ss"));
a<=game.scoreM&&(a=game.scoreM,cc.sys.localStorage.setItem("MaxScore_ss",a));this.labelMaxScore=new cc.LabelAtlas("0",res.fint3537_png,35,37,"0");this.labelMaxScore.setAnchorPoint(cc.p(0,0.5));this.labelMaxScore.setPosition(cc.p(0.55*this.size.width,0.525*this.size.height));this.labelMaxScore.setString(a);this.addChild(this.labelMaxScore,1);return!0},moveTo:function(){this.runAction(cc.moveTo(0.8,cc.p(0,0)).easing(cc.easeElasticOut(0.3)))},returnHome:function(){window.location.href="/"}});
game.ShareGuidLayer=cc.Layer.extend({ctor:function(){this._super();var a=new cc.Sprite(res.shareLayer_png);a.setPosition(cc.p(240,400));this.addChild(a);a=cc.spriteFrameCache.getSpriteFrame("offBtn.png");a=new cc.Sprite(a);a=new cc.MenuItemSprite(a,null,function(){this.removeFromParent()},this);a.attr({x:390,y:592,anchorX:0.5,anchorY:0.5});a=new cc.Menu(a);a.x=0;a.y=0;this.addChild(a);this.touchListener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,
c){return!0}});cc.eventManager.addListener(this.touchListener,this);return!0}});game.PlayLayer=cc.Layer.extend({listIce:null,listHand:[],iceCount:null,iceZ:null,firstIcePt:null,IcePt:null,listHandPt:null,isMoved:null,moveDataX:null,moveDataY:null,moveDirection:null,iceDirection:null,hand1:null,hand2:null,hand3:null,hand4:null,countHand:null,ctor:function(){this._super();this.listIce=[];this.listHand=[];this.listHandPt=[1,2,3,4];this.isMoved=!1;this.moveDataY=this.moveDataX=0;this.iceDirection=this.moveDirection="normal";this.iceCount=0;this.size=cc.winSize;var a=new cc.Sprite(res.gameBG_jpg);
a.setPosition(cc.p(240,400));this.addChild(a);this.scoreBgSp=new cc.Sprite(res.scoreBg_png);this.scoreBgSp.setPosition(cc.p(this.size.width/2,this.size.height-this.scoreBgSp.height/2));this.addChild(this.scoreBgSp,5);var b=this;this.timeSp=new game.SkillSprite(cc.spriteFrameCache.getSpriteFrame("clocktime1.png"),cc.spriteFrameCache.getSpriteFrame("clock.png"),function(){b.timeSp.stopAllActions();b.timeSp.ss.visible=!0;b.fGameOver()},this);this.timeSp.setPosition(cc.p(440,740));this.addChild(this.timeSp);
this.timeSp.fCoolingSkill();this.quanSp=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("quan.png"));this.quanSp.setPosition(cc.p(238,382));this.quanSp.scale=0.8;this.addChild(this.quanSp);this.quanSp.runAction(cc.sequence(cc.scaleTo(1.5,0.6),cc.scaleTo(1.5,0.8)).repeatForever());this.quanSp.visible=!1;this.fCreateLevel();game.scoreM=0;this.labelScore=new cc.LabelAtlas("0",res.fint3537_png,35,37,"0");this.labelScore.setPosition(cc.p(0.45*this.size.width,this.size.height-40));this.labelScore.setAnchorPoint(cc.p(0,
0.5));this.addChild(this.labelScore,5);this.touchListener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,d){return 0==b.listIce.length?!1:!0},onTouchMoved:function(a,d){a.getLocation();var e=a.getDelta();b.moveDataX+=e.x;b.moveDataY+=e.y;Math.abs(b.moveDataX)>Math.abs(b.moveDataY)?10<Math.abs(b.moveDataX)&&(0<b.moveDataX?(b.isMoved=!0,b.moveDirection="right"):(b.isMoved=!0,b.moveDirection="left")):10<Math.abs(b.moveDataY)&&(0<b.moveDataY?
(b.isMoved=!0,b.moveDirection="up"):(b.isMoved=!0,b.moveDirection="down"));b.fMoveIce(b.moveDirection);cc.log(b.moveDirection)},onTouchEnded:function(a,d){b.fMoveIceSprite(b.moveDirection);b.moveDirection="normal";b.moveDataX=0;b.moveDataY=0;if(!b.isMoved){if(!b.fChickMove())return;1<b.listIce.length&&b.fSwapIce()}b.isMoved=!1}});cc.eventManager.addListener(this.touchListener,this);this.scheduleUpdate();return!0},update:function(a){80<=this.timeSp.left.getPercentage()&&(this.unscheduleUpdate(),this.timeSp.runAction(cc.blink(1,
5).repeatForever()))},fGameOver:function(){var a=new game.MenuOverLayer;a.x=-340;this.addChild(a,10);a.moveTo()},fRaiseScore:function(a){game.scoreM+=a;this.labelScore.setString(game.scoreM);this.timeSp.left.setPercentage(this.timeSp.left.getPercentage()-20);this.timeSp.left.stopAllActions();this.timeSp.left.runAction(this.timeSp.action.clone())},fMoveIceSprite:function(a){var b=this.listIce[0];0<b.getNumberOfRunningActions()&&b.stopAllActions();if("right"==a)if(this.hand2){b.setRotation(-40);var c=
this.hand2.listShowIceType[this.hand2.iceCount];b.runAction(cc.sequence(cc.moveTo(0.2,cc.p(420-20*this.hand2.iceCount,18*this.hand2.iceCount+434)),cc.callFunc(function(){if(c!=b.type)cc.log("game over!");else if(this.hand2.iceCount+=1,this.hand2.listReceiveIce.push(b),this.hand2.iceCount==this.hand2.listShowIceType.length){for(var a=0;a<this.hand2.listReceiveIce.length;a++)this.hand2.listReceiveIce[a].removeFromParent();this.fRaiseScore(20*this.hand2.iceCount);a=new fAction(1,8,"light");this.hand2.setRotation(-90);
this.hand2.runAction(cc.sequence(a,cc.callFunc(function(){this.hand2.removeFromParent();this.countHand-=1;0==this.countHand&&(this.quanSp.visible=!1,this.fCreateLevel())},this)))}},this)));this.listIce.splice(0,1);for(a=0;a<this.listIce.length;a++){var d=this.listIce[a],e=cc.p(d.x+20,d.y-20*(300/290));d.setZOrder(d.getZOrder()+1);d.runAction(cc.moveTo(0.2,e))}}else b.runAction(cc.sequence(cc.moveTo(0.2,cc.p(550,400)),cc.callFunc(function(){cc.log("gameOver!!!!!!")},this)));else if("left"==a)if(this.hand4){b.setRotation(50);
c=this.hand4.listShowIceType[this.hand4.iceCount];b.runAction(cc.sequence(cc.moveTo(0.2,cc.p(60+20*this.hand4.iceCount,18*this.hand4.iceCount+434)),cc.callFunc(function(){if(c!=b.type)cc.log("game over!");else if(this.hand4.iceCount+=1,this.hand4.listReceiveIce.push(b),this.hand4.iceCount==this.hand4.listShowIceType.length){for(var a=0;a<this.hand4.listReceiveIce.length;a++)this.hand4.listReceiveIce[a].removeFromParent();this.fRaiseScore(20*this.hand4.iceCount);a=new fAction(1,8,"light");this.hand4.setRotation(90);
this.hand4.runAction(cc.sequence(a,cc.callFunc(function(){this.hand4.removeFromParent();this.countHand-=1;0==this.countHand&&(this.quanSp.visible=!1,this.fCreateLevel())},this)))}},this)));this.listIce.splice(0,1);for(a=0;a<this.listIce.length;a++)d=this.listIce[a],e=cc.p(d.x+20,d.y-20*(300/290)),d.setZOrder(d.getZOrder()+1),d.runAction(cc.moveTo(0.2,e))}else b.runAction(cc.moveTo(0.2,cc.p(-50,400)));else if("up"==a)if(this.hand1){b.setRotation(180);c=this.hand1.listShowIceType[this.hand1.iceCount];
b.runAction(cc.sequence(cc.moveTo(0.2,cc.p(this.hand1.x-10,620-20*this.hand1.iceCount)),cc.callFunc(function(){if(c!=b.type)cc.log("game over!");else if(this.hand1.iceCount+=1,this.hand1.listReceiveIce.push(b),this.hand1.iceCount==this.hand1.listShowIceType.length){for(var a=0;a<this.hand1.listReceiveIce.length;a++)this.hand1.listReceiveIce[a].removeFromParent();this.fRaiseScore(20*this.hand1.iceCount);a=new fAction(1,8,"light");this.hand1.setRotation(180);this.hand1.runAction(cc.sequence(a,cc.callFunc(function(){this.hand1.removeFromParent();
this.countHand-=1;0==this.countHand&&(this.quanSp.visible=!1,this.fCreateLevel())},this)))}},this)));this.listIce.splice(0,1);for(a=0;a<this.listIce.length;a++)d=this.listIce[a],e=cc.p(d.x+20,d.y-20*(300/290)),d.setZOrder(d.getZOrder()+1),d.runAction(cc.moveTo(0.2,e))}else b.runAction(cc.moveTo(0.2,cc.p(240,850)));else if("down"==a)if(this.hand3){c=this.hand3.listShowIceType[this.hand3.iceCount];b.runAction(cc.sequence(cc.moveTo(0.2,cc.p(this.hand3.x+14,110+20*this.hand3.iceCount)),cc.callFunc(function(){if(c!=
b.type)cc.log("game over!");else if(this.hand3.iceCount+=1,this.hand3.listReceiveIce.push(b),this.hand3.iceCount==this.hand3.listShowIceType.length){for(var a=0;a<this.hand3.listReceiveIce.length;a++)this.hand3.listReceiveIce[a].removeFromParent();this.fRaiseScore(20*this.hand3.iceCount);a=new fAction(1,8,"light");this.hand3.setRotation(0);this.hand3.runAction(cc.sequence(a,cc.callFunc(function(){this.hand3.removeFromParent();this.countHand-=1;0==this.countHand&&(this.quanSp.visible=!1,this.fCreateLevel())},
this)))}},this)));this.listIce.splice(0,1);for(a=0;a<this.listIce.length;a++)d=this.listIce[a],e=cc.p(d.x+20,d.y-20*(300/290)),d.setZOrder(d.getZOrder()+1),d.runAction(cc.moveTo(0.2,e))}else b.runAction(cc.moveTo(0.2,cc.p(240,-50)))},fMoveIce:function(a){var b=this.listIce[0];0<b.getNumberOfRunningActions()||("right"!=this.iceDirection&&"right"==a?(b.runAction(cc.moveBy(0.1,cc.p(20,0))),this.iceDirection="right"):"left"!=this.iceDirection&&"left"==a?(b.runAction(cc.moveBy(0.1,cc.p(-20,0))),this.iceDirection=
"left"):"up"!=this.iceDirection&&"up"==a?(b.runAction(cc.moveBy(0.1,cc.p(0,20))),this.iceDirection="up"):"down"!=this.iceDirection&&"down"==a&&(b.runAction(cc.moveBy(0.1,cc.p(0,-20))),this.iceDirection="down"))},fSwapIce:function(){var a=this.listIce[0],b=this.listIce[this.listIce.length-1].getPosition();a.runAction(cc.moveTo(0.2,b));a.setZOrder(0);for(b=1;b<this.listIce.length;b++){var c=this.listIce[b],d=cc.p(c.x+20,c.y-20*(300/290));c.setZOrder(c.getZOrder()+1);c.runAction(cc.moveTo(0.2,d));this.listIce[b-
1]=this.listIce[b]}this.listIce[this.listIce.length-1]=a},fChickMove:function(){for(var a=!0,b=1;b<this.listIce.length;b++)if(0<this.listIce[b].getNumberOfRunningActions()){a=!1;break}return a},fCreateLevel:function(){this.listIce=[];this.listHand=[];this.hand4=this.hand3=this.hand2=this.hand1=null;this.countHand=0;var a=Math.floor(3*Math.random()+1);this.iceZ=this.iceCount=a;this.IcePt=cc.p(240,400);this.iceCount-=1;this.schedule(this.fCreateOnceIce,0.2,this.iceCount,0)},fCreateOnceIce:function(){var a=
new game.IceSprite;a.setPosition(cc.p(-50,700));this.addChild(a,this.iceZ);this.iceZ-=1;this.listIce.push(a);a.fMoveSelf(this.IcePt);this.IcePt=cc.p(this.IcePt.x-20,20*(300/290)+this.IcePt.y);if(0==this.iceZ)switch(this.quanSp.visible=!0,this.listIce.length){case 1:this.fSelectNum(1,1);this.countHand=1;break;case 2:a=Math.floor(2*Math.random()+1);this.fSelectNum(2,a);this.countHand=a;break;case 3:a=Math.floor(2*Math.random()+2),this.fSelectNum(3,a),this.countHand=a}},fCreateHand:function(a,b){var c=
new game.HandSprite(b);c.listShowIceType.push(a);c.type=b;c.dialogBoxPt=null;this.addChild(c);var d=c.getPosition(),e=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("piture.png"));c.listReceiveIce.push(e);this.listHand.push(c);switch(b){case 1:e.setPosition(cc.p(d.x+80,d.y-50));e.setRotation(c.getRotation()+20);e.scaleX=-1;c.dialogBoxPt=cc.p(d.x+70,d.y-50);this.hand1=c;break;case 2:e.setPosition(cc.p(d.x-90,d.y-60));e.setRotation(c.getRotation()-100);e.scaleX=-1;c.dialogBoxPt=cc.p(d.x-90,d.y-60);
this.hand2=c;break;case 3:e.setPosition(cc.p(d.x-70,d.y+40));e.setRotation(c.getRotation()+20);e.scaleX=-1;c.dialogBoxPt=cc.p(d.x-70,d.y+40);this.hand3=c;break;case 4:e.setPosition(cc.p(d.x+40,d.y+110)),e.setRotation(c.getRotation()+60),e.scaleX=-1,c.dialogBoxPt=cc.p(d.x+50,d.y+100),this.hand4=c}this.addChild(e)},fSelectNum:function(a,b){for(var c=this.listHandPt.slice(0),d=this.listIce.slice(0),e=0,f=c.length;e<b;e++){var g=Math.floor(Math.random()*f),h=c[g],k=Math.floor(Math.random()*d.length),
m=d[k].type;d.splice(k,1);this.fCreateHand(m,h);c[g]=c[f-1];f--}for(c=0;c<d.length;c++)e=d[c].type,f=Math.floor(Math.random()*this.listHand.length),this.listHand[f].listShowIceType.push(e),d[c]=void 0,d.splice(c,1);for(d=0;d<this.listHand.length;d++){c=this.listHand[d];cc.log("222",c.listShowIceType.length);for(e=0;e<c.listShowIceType.length;e++)f=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("ice"+c.listShowIceType[e]+".png")),c.listReceiveIce.push(f),f.scale=0.8,f.setPosition(cc.p(c.dialogBoxPt.x,
c.dialogBoxPt.y-10+15*e)),this.addChild(f)}}});game.PlayScene=cc.Scene.extend({onEnter:function(){this._super();var a=new game.PlayLayer;this.addChild(a)}});
game.SkillSprite=cc.Sprite.extend({bCooling:null,ctor:function(a,b,c){this._super(b);this.bCooling=!0;var d=this;this.action=cc.sequence(cc.progressTo(8,100),new cc.CallFunc(function(){d.bCooling=!0;c()}));this.ss=new cc.Sprite(a);this.left=new cc.ProgressTimer(this.ss);this.left.type=cc.ProgressTimer.TYPE_RADIAL;this.left.setPosition(cc.p(this.width/2,this.height/2));this.left.setReverseDirection(!0);this.addChild(this.left);this.left.midPoint=cc.p(0.5,0.5);return!0},fCoolingSkill:function(){this.bCooling&&
(this.left.setPercentage(1E-5),this.left.runAction(this.action.clone()),this.bCooling=!1)}});
game.HandSprite=cc.Sprite.extend({place:null,listShowIceType:null,listReceiveIce:null,iceCount:null,ctor:function(a){this.place=a;this.listShowIceType=[];this.listReceiveIce=[];this.iceCount=0;this.size=cc.winSize;a=Math.floor(4*Math.random()+1);this._super(cc.spriteFrameCache.getSpriteFrame("hand"+a+".png"));return!0},onEnter:function(){this._super();switch(this.place){case 1:this.setRotation(130);this.setPosition(cc.p(this.size.width/2,this.size.height-this.height-20));break;case 2:this.setScaleX(-1);
this.setPosition(cc.p(this.size.width,this.size.height/2));break;case 3:this.setRotation(-50);this.setPosition(cc.p(this.size.width/2,this.height/2));break;case 4:this.setPosition(cc.p(0,this.size.height/2))}return!0}});
game.IceSprite=cc.Sprite.extend({type:null,ctor:function(){this.size=cc.winSize;var a=Math.floor(6*Math.random()+1);this.type=a;this._super(cc.spriteFrameCache.getSpriteFrame("ice"+a+".png"));return!0},fMoveSelf:function(a){a=new cc.MoveTo(0.5,a);this.runAction(cc.sequence(a.easing(cc.easeElasticOut(0.6)),cc.callFunc(function(){},this)))}});fAction=function(a,b,c){for(var d=[];a<b;a++){var e=cc.spriteFrameCache.getSpriteFrame(c+a+".png");d.push(e)}b=new cc.Animation(d,0.05);return new cc.Animate(b)};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));"iOS"==cc.sys.os?cc.view.enableRetina(!0):cc.view.enableRetina(!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(480,800,cc.ResolutionPolicy.EXACT_FIT);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){},this)};cc.game.run();